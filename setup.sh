...
echo ""
echo "  3. Create your first project knowledge folder (no Obsidian needed):"
echo "     mkdir -p ~/your-project/knowledge"
echo "     cp templates/shipstack/past-mistakes.md ~/your-project/knowledge/"
